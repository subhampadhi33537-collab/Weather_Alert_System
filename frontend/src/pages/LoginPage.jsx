  ...
  return (
    <div className="flex-center" style={{ minHeight: '80vh' }}>
      <div className="glass-panel" style={{ padding: '2rem', width: '100%', maxWidth: '400px' }}>
        <h2 className="neon-text-cyan" style={{ marginBottom: '1.5rem', textAlign: 'center' }}>Login</h2>
        ...
        <div style={{ marginTop: '1.5rem', textAlign: 'center', color: '#a0aec0' }}>
          Don't have an account? <Link to="/signup" className="neon-text-cyan" style={{ textDecoration: 'none' }}>Sign up</Link>
        </div>
      </div>
    </div>
  );
